        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-4">
            ...
            <p className="text-white/70 mb-3">
              Av. Infante D. Henrique, nº 77<br />
              7350-100 Elvas, Portugal
            </p>
            <p className="text-white/70 mb-3">
              <a href="tel:+351967341421" className="hover:text-white transition-colors">+351 967 341 421</a>
            </p>
            <p className="text-white/70 mb-6">
              <a href="mailto:geral@datawise.pt" className="hover:text-white transition-colors">geral@datawise.pt</a>
            </p>
          </div>
        </div>
      </div>
