    ...
    visual: (
      <div className="space-y-3">
        <div className="landing-citation">
          ...
          <div className="text-white text-sm font-medium">Art. 483.º — Código Civil</div>
          <div className="text-[#9fb3c8] text-xs mt-1">
        ...
        <div className="landing-citation">
          ...
          <div className="text-white text-sm font-medium">Art. 562.º — Código Civil</div>
          <div className="text-[#9fb3c8] text-xs mt-1">
    ...
    visual: (
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          <div className="text-xs text-[#9fb3c8] w-28 text-right shrink-0">Pesquisa manual</div>
          <div className="flex-1 bg-[#243b53] rounded-full h-7 relative overflow-hidden">
            <div
        ...
        <div className="flex items-center gap-3">
          <div className="text-xs text-[#9fb3c8] w-28 text-right shrink-0">Datawise Lex</div>
          <div className="flex-1 bg-[#243b53] rounded-full h-7 relative overflow-hidden">
            <div
              className="h-full rounded-full flex items-center justify-end pr-3"
              style={{
                width: "8%",
                background: "linear-gradient(90deg, #c9a55a, #dfc07d)",
                minWidth: "80px",
              }}
            >
              <span className="text-xs text-[#0a1929] font-bold ml-2">&lt; 3s</span>
            </div>
          </div>
        </div>
        <p className="text-xs text-[#627d98] text-center mt-2">
  ...
  },
  {
    ...
    visual: (
      <div className="space-y-2.5">
        {[
          { name: "Ana Sousa", role: "Admin", color: "bg-[rgba(201,165,90,0.15)] border-[rgba(201,165,90,0.3)] text-[#c9a55a]" },
  ...
  },
  {
    ...
    visual: (
      <div className="flex flex-col items-center justify-center h-full gap-4 py-4">
        <div className="w-16 h-16 rounded-2xl bg-[rgba(201,165,90,0.1)] border border-[rgba(201,165,90,0.2)] flex items-center justify-center">
              ...
              >
                ...
                <div className={!isEven ? "lg:[direction:ltr]" : ""}>
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-9 h-9 rounded-lg bg-[rgba(201,165,90,0.12)] border border-[rgba(201,165,90,0.2)] flex items-center justify-center">
