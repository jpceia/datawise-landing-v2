        ...
        <div className="md:flex">
          ...
          <div className="md:flex-1 p-6 md:p-8">
            <div className="flex items-center text-sm text-gray-500 mb-3">
              <span className="mr-4">{formatDate(post.publishedAt, locale)}</span>
              {post.category && <span className="bg-primary/10 text-primary px-2 py-0.5 rounded-full text-xs">{post.category}</span>}
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4 group-hover:text-primary transition-colors">{post.title}</h2>
        ...
        <div className="relative h-48">
          ...
          {post.category && (
            <div className="absolute bottom-4 left-4">
              <span className="bg-primary/80 backdrop-blur-sm text-white px-3 py-1 rounded-full text-xs font-medium">{post.category}</span>
            </div>
          )}
        </div>
        <div className="p-6">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-primary transition-colors line-clamp-2">{post.title}</h3>
