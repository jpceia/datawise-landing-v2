          ...
          {FEATURES.map((f, i) => {
            ...
            return (
              <motion.div
                ...
                className={`landing-card relative ${f.soon ? "opacity-90" : ""}`}
              >
                {f.soon && (
                ...
                <div className="w-10 h-10 rounded-lg bg-[rgba(66,165,245,0.14)] border border-[rgba(66,165,245,0.3)] flex items-center justify-center mb-4">
