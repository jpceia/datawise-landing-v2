  ...
  return (
    <section>
      <div className="mb-10 flex flex-col items-center gap-4 text-center sm:flex-row sm:items-end sm:justify-between sm:text-left">
        <div>
          <p className="text-xs font-medium tracking-[0.18em] text-primary-700/80 uppercase dark:text-primary-100/70">Pricing</p>
      ...
      <div className="grid gap-6 lg:grid-cols-3 lg:gap-5">
        ...
        <article className="flex flex-col rounded-2xl border border-zinc-200 bg-white/85 p-8 transition duration-300 hover:border-zinc-300 dark:border-white/[0.08] dark:bg-zinc-900/80 dark:hover:border-white/15">
          ...
          <ul className="flex-1 space-y-3 text-sm text-zinc-700 dark:text-zinc-300">
            <li className="flex items-start gap-2.5">
              <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-primary-300/60" />
              OCR base
            </li>
            <li className="flex items-start gap-2.5">
              <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-primary-300/60" />
        ...
        <article className={`relative flex flex-col rounded-2xl bg-white/90 p-8 dark:bg-zinc-900/95 ${styles.glowPulse} ${styles.gradientBorder}`}>
          <div className="flex items-center justify-between gap-3">
            <p className="text-sm font-semibold tracking-wide text-primary-100 uppercase">Pro</p>
            <span className={`rounded-full border border-primary-100/30 px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-primary-100 ${styles.shimmer}`}>
              recomendado
            </span>
          </div>
          ...
          <div className="mt-6 rounded-xl border border-zinc-200 bg-white/80 p-5 dark:border-white/[0.08] dark:bg-zinc-950/80">
            <div className="mb-3 flex items-center justify-between text-xs text-zinc-600 dark:text-zinc-400">
              ...
              <span className="rounded-md bg-primary-400/15 px-2 py-0.5 font-bold text-primary-100">{proInvoices}</span>
            </div>
            <input
              type="range"
              min={0}
              ...
              className="h-2 w-full cursor-pointer appearance-none rounded-lg bg-zinc-300 accent-primary-500 dark:bg-zinc-700 dark:accent-primary-300"
                ...
                <button
                  ...
                  className={`rounded-lg px-1 py-1 font-medium transition duration-200 ${
                    selectedProIndex === index
                      ? "bg-primary-300/15 text-primary-100 ring-1 ring-primary-300/20"
          ...
          <div className="my-6 h-px bg-gradient-to-r from-transparent via-primary-300/20 to-transparent" />
          ...
          <Link
            href="/register"
            className="group mt-8 inline-flex w-full items-center justify-center gap-2.5 rounded-xl bg-gradient-to-r from-primary-600 to-primary-500 px-4 py-3 text-sm font-bold text-white transition duration-300 hover:from-primary-500 hover:to-primary-400 hover:shadow-lg hover:shadow-primary-500/20"
          >
            Comecar grátis
        ...
        <article className="flex flex-col rounded-2xl border border-zinc-200 bg-white/85 p-8 transition duration-300 hover:border-zinc-300 dark:border-white/[0.08] dark:bg-zinc-900/80 dark:hover:border-white/15">
          <div className="flex items-center gap-2.5 text-zinc-800 dark:text-zinc-200">
            <Building2 className="h-4.5 w-4.5 text-primary-200" />
