  ...
  return (
    <section>
      <div className="mb-12 text-center">
        <p className="text-xs font-medium tracking-[0.18em] text-primary-700/80 uppercase dark:text-primary-100/70">FAQs</p>
      ...
      >
        {faqs.map((faq, index) => (
          ...
          >
            <AccordionTrigger className="py-6 text-left text-base font-semibold text-zinc-800 transition-colors duration-300 hover:text-primary-700 hover:no-underline dark:text-zinc-200 dark:hover:text-primary-100 md:text-lg">
              {faq.question}
            </AccordionTrigger>
