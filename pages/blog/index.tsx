  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Artigos, guias e notícias sobre ciência de dados, machine learning e casos de sucesso da DataWise." />
          ...
          <div className="container mx-auto px-4">
            {filteredPosts.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-6">
                  Não encontrámos nenhum artigo que corresponda aos seus critérios de pesquisa.
                </p>
                <Button 
                  variant="primary" 
                  onClick={() => {
                ...
                <div className="md:flex">
                  <div className="md:w-3/5 p-8 md:p-10">
                    ...
                    <p className="text-white/60 text-sm mt-4">
                      Prometemos não enviar spam. Pode cancelar a subscrição a qualquer momento.
                    </p>
                  </div>
